...
$scope.addnew = function() {
  ...
  for (i=0;i<=$scope.pur1.length-1;i++){
    console.log($scope.color.state)
     ...
     $scope.pur1[i].displaydate = $scope.tax.displaydate
...
$scope.updated = function() {
  ...
  for (i=0;i<=forupdate.length-1;i++){
     ...
     forupdate[i].displaydate = $scope.tax.displaydate
