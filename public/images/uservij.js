        ...
        for(i=0;i<countlength;i++){
            ...
            console.log(catitem[i].count)
              total = count * section;
                ...
                catitem[i].totalgst = catitem[i].taxcgst + catitem[i].taxsgst;
                  console.log( catitem[i].totalgst)
                var ihr = total - catitem[i].totalgst;
                console.log(ihr)
                
                
                console.log($scope.discountval)
                  $scope.discountamt = ihr*$scope.discountval/100;
                 console.log(total)
                 console.log($scope.discountamt)
                  catitem[i].discountamt=$scope.discountamt;
                
                console.log($scope.chargecountvalitem)
                 $scope.chargeamt = ihr*$scope.chargecountvalitem/100;
                 console.log($scope.chargeamt)
              total +=  $scope.chargeamt;
                 console.log(total)
                // catitem[i].total -= total;
 ...
 $scope.myFunc = function(amount) {
    ...
    $scope.change = amount - $scope.total;
     ...
     console.log($scope.change)
         ...
         $scope.poscart=function(mobile,catitem1,total,totquant,serchar,sercharc,serchars,totGst,subtol,myVar,change,sesdate,session){
            alert("function working")
             window.sessionStorage.setItem("mooob", mobile)
              var restbill = window.sessionStorage.getItem("loginres1")
         console.log(restbill) 

             console.log(mobile,catitem1,subtol,totquant,serchar,sercharc,serchars,totGst,total,myVar,$scope.change,session,sesdate);
...
var poscartt =mobile+","+catitem1[i].name+","+catitem1[i].section+","+catitem1[i].count+","+catitem1[i].total+","+total+","+totquant+","+serchar+","+sercharc+","+serchars+","+totGst+","+subtol+","+myVar+","+i+","+catitem1[i].selected+","+rschange+","+change+","+sesdate+","+session+","+restbill+","+catitem1[i].positemtype;
...
$scope.loginnnn=window.sessionStorage.getItem("loginres1"); 
         ...
         $http.get('/prnsession').success(function(response){
               console.log("in save button");
                  console.log(response);
              $scope.session00 = response;
        $scope.sesdate1 =  $scope.session00[0].date;
            ...
            obj["name"] = $scope.bill.name;
             ...
             obj["itemtotal"] = $scope.bill.itemtotal;
               obj["subtotal"] = $scope.billsumm[0].Subtotal; 
                     ...
                     obj["Orderstatus"] = $scope.billsumm[0].Orderstatus;
                           ...
                           console.log("sdfdsasdfgh"+billcarlength)
                             ...
                             for(j=0;j<=billcarlength-1;j++){
                                 ...
                                 if(arrcon.indexOf($scope.billcar[j].alias)==-1){
                                        ...
                                        obj["alias1"] = billarray[j].alias;
                                     
                                        console.log(billarray[j].itemtotal)
                                     
                                      obj["itemtota"] = billarray[j].itemtotal;
                                    
                                      obj["taxname"] = $scope.sumtax[0].taxname;
                                    ...
                                    console.log($scope.arrcon5)
                                     ...
                                     for(h=0;h<=billcarlength-1;h++){
                                         //alert("2237"+h)
                                         console.log(h)
                                     console.log($scope.billcar[j].tax.length)
                                         if(h!=billlength-1){
                                     console.log($scope.billcar[j])
                                         console.log($scope.billcar[j].tax[h])
                                         console.log($scope.billcar[j].tax[h].Rate)
                                       var tgst = parseInt($scope.billcar[j].tax[h].Rate);
                                         //console.log(tgst)
                                        $scope.tgst+=tgst;
                                        // console.log($scope.tgst)
                                         console.log($scope.arrcon5[h].itemtota)
                                         hidgst = parseFloat($scope.arrcon5[h].itemtota*$scope.tgst/100);
//                                        console.log(total)
                                         console.log(billlength)
                                       
                                         
                                        hidrate= parseFloat($scope.arrcon5[h].itemtota-hidgst);
                                         //console.log(hidrate)
                                        // alert(hidrate)
                                          obj["hidgst"] = hidgst;
                                          obj["hidrate"] = hidrate;
...
//                                     
//                                     console.log($scope.arrcon5.length)
//                                      for(m=0;m<=$scope.arrcon5.length-1;m++){
//                                            var total = 0;
//                                            alert("exited"+m)
//                                          for(n=0;n<=billcarlength-1;n++){
//                                            
//                                                //console.log($scope.arrcon5[h].alias)
//                                             console.log($scope.billcar[n].alias)
//                                              if($scope.arrcon5[m].alias == $scope.billcar[n].alias){
//                                                  alert("hhhhhhhhhhhh"+m)
...
//                                                  console.log($scope.arrcon5[m].hidrate)
//                                                  console.log($scope.arrcon5[m])
//                                                hidgst = parseFloat($scope.arrcon5[m].itemtota*$scope.tgst/100);
//                                        console.log(hidgst)
//                                                $scope.arrcon5[m].hidgst = hidgst;
//                                                  
//                                                   hidrate= parseFloat($scope.arrcon5[m].itemtota-hidgst);
//                                                  console.log(hidrate)
//                                                   $scope.arrcon5[m].hidrate = hidrate;
//                                                  console.log($scope.arrcon5[m].hidgst)
//                                                  console.log($scope.billcar[n].hidgst)
//                                                 console.log($scope.arrcon5[m].itemtota)
//                                                  
//                                              }
//                                              var totl=0;
...
//                                var object = {};
//                                 
//                                 if(arrcon.indexOf($scope.billcar[j].itemtype)==-1){
//                                         console.log($scope.billcar[j].itemtype)
//                                     object["itemType"] = billarray[j].itemtype;
//                                        arrconn3.push(object);
//                                    console.log(arrconn3)
//                                  $scope.arrconn3 = arrconn3;
//                                    console.log($scope.arrconn3);
//                                      }
//var restorepage = document.body.innerHTML;
//           var contents = "<html><head></head<title><h1>Welcome to</h1>"+login00+"<h3>Ittegi Road Dharwad, ph:-12345  </h3><h3>Cash Bill</h3>"+$scope.arrconn3[j].itemType+"</title>"     
//         contents = contents + "</head><body>"
//       contents=contents+"<table class=\"table table-striped\"><thead><tr><th>SL NO</th><th>Item Name</th><th>Quantity</th><th>Value</th></tr></thead>";
// var i=0;
////     alert($scope.billcar.length)
////        for(b=0;b<$scope.billcar.length;b++)
////        {
//            console.log("welcome")
//            contents = contents+"<tr >;&nbsp"
//            contents = contents+"<td>"+(i+1)+"</td>&nbsp"
//            contents = contents+"<td>"+$scope.billcar[i].name+"</td>&nbsp"
//            contents = contents+"<td>"+$scope.billcar[i].Price+"</td>&nbsp"
//             contents = contents+"<td>"+$scope.billcar[i].quantity+"</td>&nbsp"
//            
//       // }         
//
//       contents = contents +"</body></html>"
...
//                             for(c=0;c<billarray.length;c++){
//                                  var kotbi;
//                                 alert(c)
//                                console.log(billarray[c].name)
//                                 var obj3 = {};
//                                 obj3["kiname"] = billarray[c].name;
//                               obj3["itemType"] = billarray[c].itemtype;
//                                 console.log(obj3)
//                                kotbi.push(obj3);
//                                 $scope.kotbill = kotbi;
//                                 console.log($scope.kotbill)
//                                 
//                               
//                             }
